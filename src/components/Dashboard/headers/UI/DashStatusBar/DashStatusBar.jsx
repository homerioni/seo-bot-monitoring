...
import s from './DashStatusBar.module.scss';

const DashStatusBar = ({statusData, className}) => {
    return (
        <div className={`${s.statusBar} ${className}`}>
            <div className={s.status}>
                <div className={`${s.statusIcon} ${s.green}`}/>
                <div>{statusData?.on}</div>
            </div>
            <div className={s.status}>
                <div className={`${s.statusIcon} ${s.purple}`}/>
                <div>{statusData?.part}</div>
            </div>
            <div className={s.status}>
                <div className={`${s.statusIcon} ${s.red}`}/>
                <div>{statusData?.off}</div>
            </div>
            <div className={s.status}>
                <div className={`${s.statusIcon} ${s.error}`}>
