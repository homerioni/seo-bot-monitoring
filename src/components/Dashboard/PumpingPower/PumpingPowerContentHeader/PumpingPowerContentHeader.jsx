...
import s from './PumpingPowerContentHeader.module.scss';

const PumpingPowerContentHeader = () => {
    return (
        <div className={s.main}>
            <div className={s.name}>
                ...
                <p>В сутки кол-во профилей</p>
            </div>
            <div className={s.name}>Сервер</div>
            <div className={s.name}>Комплектация</div>
            <div className={s.name}>Локация</div>
            <div className={s.name}>Тип подключения</div>
        </div>
    );
};

export default PumpingPowerContentHeader;