...
import s from './ServerTabs.module.scss';

const ServerTabs = ({activeTab, setActiveTab, setModalLoadLogs, server}) => {
    const tabs = [
        'Потоки',
        'Информация',
        'Конфигурация',
    ...
    return (
        <div className={s.main}>
            ...
            <button type='button' className={s.downloadLog} onClick={() => setModalLoadLogs({isOpen: true, serverId: server.id})}>
