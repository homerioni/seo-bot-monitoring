...
import s from './ModalUpdateButtons.module.scss';
import Loading from "../../../UI/Loading/Loading";

const ModalUpdateButtons = ({setClose, isLoading, isValid}) => {
    return (
        <div className={s.main}>
            ...
            <button type="button" className={s.cancel} onClick={() => setClose(true)}>
                <span>Отменить</span>
            </button>
        </div>
    );
...
export default ModalUpdateButtons;